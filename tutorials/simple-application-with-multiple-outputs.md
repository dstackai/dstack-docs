...
{% hint style="info" %}
**Source Code:** [**https://github.com/dstackai/dstack-examples/blob/master/tutorials/multiple\_outputs.py**](https://github.com/dstackai/dstack-examples/blob/master/tutorials/multiple_outputs.py)\*\*\*\*
{% endhint %}
